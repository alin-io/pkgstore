...
import {LibConfig, PackageItem} from "@/components/index";
            ...
            <li key={item.id} className="relative flex justify-between gap-x-6 py-5">
              <div className="flex items-center gap-x-4">
                ...
                <div className="min-w-0 flex-auto">
                  <p className="text-sm font-semibold leading-6 text-gray-900">
                    <Link href={LibConfig.Routes.Package(item.id)}>
              ...
              <div className="flex items-center gap-x-4">
                <div className="hidden sm:flex sm:flex-col sm:items-end">
                  <p className="text-sm leading-6 text-gray-900 inline-flex items-center"><ServiceIcon name={item.service} className="-ml-0.5 mr-2 h-6 w-6" />{item.service}</p>
                  {item.updated_at ? (
